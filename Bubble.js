...
import { Text, Clipboard, StyleSheet, TouchableWithoutFeedback, View, TouchableOpacity } from 'react-native';
...
export default class Bubble extends React.Component {
    ...
    render() {
        ...
        <View style={[
          ...
          <TouchableOpacity onPress={this.onPress} accessibilityTraits='text' {...this.props.touchableProps}>
            <View>
